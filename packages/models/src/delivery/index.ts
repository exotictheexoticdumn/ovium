...
const ASSET_URL = new URL("../../assets/vehicles/delivery.glb", import.meta.url).href;

export type DeliveryTruckOptions = GLTFVehicleOptions;

/**
 * A boxy delivery van/truck.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createDeliveryTruck(options: DeliveryTruckOptions = {}) {
