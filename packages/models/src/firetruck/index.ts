...
const ASSET_URL = new URL("../../assets/vehicles/firetruck.glb", import.meta.url).href;

export type FireTruckOptions = GLTFVehicleOptions;

/**
 * A fire truck with a front grill part.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createFireTruck(options: FireTruckOptions = {}) {
