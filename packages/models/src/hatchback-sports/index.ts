...
const ASSET_URL = new URL("../../assets/vehicles/hatchback-sports.glb", import.meta.url).href;

export type SportsHatchbackOptions = GLTFVehicleOptions;

/**
 * A compact sports hatchback.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createSportsHatchback(options: SportsHatchbackOptions = {}) {
