...
const ASSET_URL = new URL("../../assets/vehicles/kart-oopi.glb", import.meta.url).href;

export type KartOopiOptions = GLTFVehicleOptions;

/**
 * A go-kart with a driver character built in.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createKartOopi(options: KartOopiOptions = {}) {
