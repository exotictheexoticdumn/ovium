...
const ASSET_URL = new URL("../../assets/vehicles/kart-oozi.glb", import.meta.url).href;

export type KartOoziOptions = GLTFVehicleOptions;

/**
 * A go-kart with a driver character built in.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createKartOozi(options: KartOoziOptions = {}) {
