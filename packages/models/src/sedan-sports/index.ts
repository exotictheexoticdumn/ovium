...
const ASSET_URL = new URL("../../assets/vehicles/sedan-sports.glb", import.meta.url).href;

export type SportsSedanOptions = GLTFVehicleOptions;

/**
 * A sportier take on the sedan body style.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createSportsSedan(options: SportsSedanOptions = {}) {
