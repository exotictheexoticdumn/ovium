...
const ASSET_URL = new URL("../../assets/vehicles/sedan.glb", import.meta.url).href;

export type SedanOptions = GLTFVehicleOptions;

/**
 * A standard low-poly sedan.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createSedan(options: SedanOptions = {}) {
