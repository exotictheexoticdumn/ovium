...
const ASSET_URL = new URL("../../assets/vehicles/suv-luxury.glb", import.meta.url).href;

export type LuxurySuvOptions = GLTFVehicleOptions;

/**
 * A luxury SUV variant.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createLuxurySuv(options: LuxurySuvOptions = {}) {
