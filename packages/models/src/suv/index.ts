...
const ASSET_URL = new URL("../../assets/vehicles/suv.glb", import.meta.url).href;

export type SuvOptions = GLTFVehicleOptions;

/**
 * A standard SUV body style.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createSuv(options: SuvOptions = {}) {
