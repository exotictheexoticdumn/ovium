...
const ASSET_URL = new URL("../../assets/vehicles/truck-flat.glb", import.meta.url).href;

export type FlatbedTruckOptions = GLTFVehicleOptions;

/**
 * A flatbed pickup truck.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createFlatbedTruck(options: FlatbedTruckOptions = {}) {
