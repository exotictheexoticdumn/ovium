...
const ASSET_URL = new URL("../../assets/vehicles/van.glb", import.meta.url).href;

export type VanOptions = GLTFVehicleOptions;

/**
 * A cargo van body style.
 * GLTF-backed (not procedural) — this returns a Promise, unlike createCar.
 */
export async function createVan(options: VanOptions = {}) {
